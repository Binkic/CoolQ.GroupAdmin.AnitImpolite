...
Uses
	math,dateutils,sysutils,mysql4,fpjson,jsonparser,Classes,dos;
	//FPImage, FPCanvas, FPImgCanv, ftFont, FPWritePNG, FPReadPNG;
	//载入库
...
Const
	CQAPPID='com.binkic.groupadmin.AnitImpolite';
		//请修改APPID为你的APPID
